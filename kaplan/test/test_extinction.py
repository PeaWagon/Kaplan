...
def test_deluge():
    ...
    for i in range(inputs.num_slots):
        ...
        ring[i].fitness = randint(1, 100)
    for i in range(1000):
        deluge(ring, ring.occupied, ring.best_pmem[1])
    ...
    for i in range(1000):
        deluge(ring2, ring2.occupied, ring2.best_pmem[1])
    ...
    for i in range(inputs.num_slots):
        ...
        ring5[i].fitness = -i
    for i in range(1000):
        deluge(ring5, ring5.occupied, ring5.best_pmem[1])
    ...
    for i in range(inputs.num_slots):
        ...
        ring6[i].fitness = -i-1
    for i in range(1000):
        deluge(ring6, ring6.occupied, ring6.best_pmem[1])
