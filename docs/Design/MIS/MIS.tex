...
\begin{table}[]
	\begin{tabular}{llll}
		Name              & In   & Out  & 
		Exceptions                                                                                                                                                                                                                     \\
		read\_ga\_input   & str  & dict & 
		FileNotFoundError                                                                                                                                                                                                              \\
		verify\_ga\_input & dict & -    & 
		\begin{tabular}[c]{@{}l@{}}ValueError\\ - num\_filled \textgreater 
		num\_slots\\ - num\_swaps \textgreater num\_geoms\\ - t\_size 
		\textgreater num\_filled\\ not an integer type\\ missng key/unknown key 
