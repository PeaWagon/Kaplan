...
\noindent * local function \wss{If they are local functions, they shouldn't
  appear in the exported access programs.  This comment applies where ever this
  is done in the MIS.}
...
\wss{State variables should have a name and type.  I'm not sure how to interpret
  this.}
